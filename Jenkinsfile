...
def upstreamProjects = [
	...
	'dia/all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-all</artifactId>
	'file/all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-file-all</artifactId>
	...
	'pages/all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-pages-all</artifactId>
	'resources/all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-all</artifactId>
